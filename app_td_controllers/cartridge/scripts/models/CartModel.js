...
var CartModel = AbstractModel.extend({
    ...
    addBonusProduct: function (bonusDiscountLineItem, product, selectedOptions, quantity) {
        ...
        var UpdateProductOptionSelections = require('app_td_core/cartridge/scripts/cart/UpdateProductOptionSelections');
    ...
    validateForCheckout: function () {
        var ValidateCartForCheckout = require('app_td_core/cartridge/scripts/cart/ValidateCartForCheckout');
